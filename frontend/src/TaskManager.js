...
function TaskManager() {
    ...
    return (
        <div className='d-flex flex-column align-items-center w-50 m-auto mt-5'>
            <h1 className='mb-4' style={{ color: 'green', fontWeight: 'bold', fontSize: '3rem'  , fontFamily:"Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif"}}>
                Task Manager App
            </h1>
            ...
            <div className='d-flex justify-content-between align-items-center mb-4 w-100'>
                ...
                <div className='input-group flex-grow-1' style={{ backgroundColor: 'rgb(44, 78, 151, 0.89)' }}>
